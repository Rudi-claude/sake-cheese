...
export const allSakes: Sake[] = [
  ...
  // 나가노
  { id: '57', name_ko: '다이신슈', name_ja: '大信州', prefecture_id: 'nagano', brewery: '다이신슈 주조', type: '준마이다이긴조', description: '나가노현 마츠모토시의 명주. 알프스의 청정수와 나가노산 미야마니시키로 빚은 우아한 사케입니다.', image_url: null, avg_rating: 4.4 },

  // 후쿠오카
  { id: '58', name_ko: '다나카 로쿠쥬고', name_ja: '田中六五', prefecture_id: 'fukuoka', brewery: '하쿠이토 주조', type: '준마이', description: '후쿠오카산 야마다니시키 100%, 정미율 65%로 빚는 순수한 사케. 미려한 감칠맛이 인상적입니다.', image_url: null, avg_rating: 4.3 },

  // 야마가타
  { id: '59', name_ko: '쿠도키죠즈', name_ja: 'くどき上手', prefecture_id: 'yamagata', brewery: '가메노이 주조', type: '준마이다이긴조', description: '야마가타현의 인기 사케. 화려한 향과 달콤한 맛으로 "유혹의 달인"이라는 이름에 걸맞는 매력을 지닙니다.', image_url: null, avg_rating: 4.5 },

  // 니가타
  { id: '60', name_ko: '마스카가미', name_ja: '〆張鶴', prefecture_id: 'niigata', brewery: '미야오 주조', type: '준마이긴조', description: '니가타 무라카미시의 전통 사케. 담백하면서도 깊은 맛이 나는 단려한 스타일의 대표주입니다.', image_url: null, avg_rating: 4.4 },

  // 아키타
  { id: '61', name_ko: '하나무라 덴로쿠', name_ja: '刈穂', prefecture_id: 'akita', brewery: '아키타 세이슈', type: '준마이', description: '아키타현의 전통 야마하이 양조법 사케. "칼로 벤 듯 깔끔한" 키레아지가 매력적인 식중주입니다.', image_url: null, avg_rating: 4.2 },

  // 시가
  { id: '62', name_ko: '후지이사쿠라', name_ja: '松の司', prefecture_id: 'shiga', brewery: '마츠노쓰카사 주조', type: '준마이다이긴조', description: '비와호의 풍부한 자연 속에서 빚어지는 시가현의 명주. 지역산 쌀로 테루아를 표현합니다.', image_url: null, avg_rating: 4.3 },

  // 오이타
  { id: '63', name_ko: '지카', name_ja: '智恵美人', prefecture_id: 'oita', brewery: '나카노 주조', type: '준마이', description: '오이타현의 감칠맛 풍부한 사케. 부드러운 목넘김과 깊은 맛이 특징입니다.', image_url: null, avg_rating: 4.2 },

  // 군마
  { id: '64', name_ko: '미즈시보리', name_ja: '水芭蕉', prefecture_id: 'gunma', brewery: '나가이 주조', type: '준마이다이긴조', description: '우오누마 지역의 명수로 빚은 사케. 샴페인 방식의 스파클링 사케 "MIZUBASHO PURE"로도 유명합니다.', image_url: null, avg_rating: 4.3 },

  // 도쿠시마
  { id: '65', name_ko: '산겐', name_ja: '三芳菊', prefecture_id: 'tokushima', brewery: '미요시키쿠 주조', type: '준마이긴조', description: '도쿠시마현의 개성파 사케. 파인애플이나 바나나 같은 강렬한 과일향이 특징입니다.', image_url: null, avg_rating: 4.1 },

  // 이바라키
  { id: '66', name_ko: '라이진', name_ja: '来福', prefecture_id: 'ibaraki', brewery: '라이후쿠 주조', type: '준마이긴조', description: '꽃 효모를 사용하는 이바라키현의 혁신적 사케. 화사하고 프루티한 향이 매력적입니다.', image_url: null, avg_rating: 4.2 },

  // 가나가와
  { id: '67', name_ko: '잇치', name_ja: '残草蓬莱', prefecture_id: 'kanagawa', brewery: '오야마 주조', type: '준마이긴조', description: '가나가와현 아츠기시의 숨은 명주. 깨끗하고 섬세한 맛이 음식의 맛을 살려줍니다.', image_url: null, avg_rating: 4.1 },

  // 야마나시
  { id: '68', name_ko: '시치켄', name_ja: '七賢', prefecture_id: 'yamanashi', brewery: '야마나시 메이조', type: '스파클링', description: '와인의 고장 야마나시에서 빚는 스파클링 사케. 와인 양조 기술을 접목한 혁신적인 사케입니다.', image_url: null, avg_rating: 4.3 },

  // 나가사키
  { id: '69', name_ko: '요코야마 고십', name_ja: '横山五十', prefecture_id: 'nagasaki', brewery: '시게타미 주조', type: '준마이다이긴조', description: '이키섬의 맥주 양조장이 사케에 도전한 신작. 50% 정미율의 야마다니시키로 빚은 깔끔한 사케입니다.', image_url: null, avg_rating: 4.4 },

  // 돗토리
  { id: '70', name_ko: '히야시', name_ja: '日置桜', prefecture_id: 'tottori', brewery: '야마네 주조', type: '준마이', description: '돗토리현의 전통 사케. 유기 재배 쌀만 사용하며, 깊은 감칠맛의 식중주입니다.', image_url: null, avg_rating: 4.0 },

  // 오카야마
  { id: '71', name_ko: '카모가타', name_ja: '御前酒', prefecture_id: 'okayama', brewery: '쓰지 본점', type: '준마이', description: '오카야마현의 유서 깊은 사케. 오미치 쌀과 키모토 양조법의 조합이 독특합니다.', image_url: null, avg_rating: 4.1 },

  // 구마모토
  { id: '72', name_ko: '레이잔', name_ja: 'れいざん', prefecture_id: 'kumamoto', brewery: '산쇼 주조', type: '준마이긴조', description: '아소산의 복류수로 빚는 구마모토현의 명주. 9호 효모의 발상지로도 유명합니다.', image_url: null, avg_rating: 4.0 },

  // 가가와
  { id: '73', name_ko: '가와쓰루', name_ja: '川鶴', prefecture_id: 'kagawa', brewery: '가와쓰루 주조', type: '준마이', description: '사누키 우동의 고장 가가와에서 빚어지는 사케. 부드럽고 밸런스 좋은 식중주입니다.', image_url: null, avg_rating: 3.9 },

  // 치바
  { id: '74', name_ko: '고잔류', name_ja: '五人娘', prefecture_id: 'chiba', brewery: '데라다혼케', type: '준마이', description: '자연주의 양조의 선구자. 무농약 쌀과 천연 효모만으로 빚는 치바현의 오가닉 사케입니다.', image_url: null, avg_rating: 4.0 },

  // 미야자키
  { id: '75', name_ko: '지토세노', name_ja: '千徳', prefecture_id: 'miyazaki', brewery: '센토쿠 주조', type: '준마이긴조', description: '소주의 본고장 미야자키에서 빚는 희귀한 사케. 남국다운 부드러운 맛이 특징입니다.', image_url: null, avg_rating: 3.8 },

  // 가고시마
  { id: '76', name_ko: '덴겐', name_ja: '天賦', prefecture_id: 'kagoshima', brewery: '니시다 주조', type: '준마이긴조', description: '소주 왕국 가고시마의 유일한 사케 양조장이 빚는 희귀한 사케입니다.', image_url: null, avg_rating: 4.0 },

  // 야마가타 추가
  { id: '77', name_ko: '토비로쿠', name_ja: '東北泉', prefecture_id: 'yamagata', brewery: '타카하시 주조', type: '준마이긴조', description: '야마가타현 유자마치의 명주. 미야마니시키를 중심으로 섬세하고 깨끗한 맛을 빚어냅니다.', image_url: null, avg_rating: 4.2 },

  // 나가노 추가
  { id: '78', name_ko: '오브세 와이너리', name_ja: '豊香', prefecture_id: 'nagano', brewery: '도요시마 주조', type: '준마이', description: '나가노현 오카야시의 전통 사케. 7호 효모를 개량한 독자 효모로 빚는 부드러운 맛이 특징입니다.', image_url: null, avg_rating: 4.1 },

  // 후쿠이 추가
  { id: '79', name_ko: '하나가키', name_ja: '花垣', prefecture_id: 'fukui', brewery: '난부 주조', type: '준마이', description: '후쿠이현 오노시의 지하수로 빚는 전통 사케. 자연 양조에 대한 고집이 담긴 순수한 맛입니다.', image_url: null, avg_rating: 4.1 },

  // 고치 추가
  { id: '80', name_ko: '도사시라기쿠', name_ja: '土佐しらぎく', prefecture_id: 'kochi', brewery: '시라기쿠 주조', type: '준마이다이긴조', description: '고치현의 전통 사케. "고치류" 드라이한 맛의 정수를 보여주는 깔끔한 식중주입니다.', image_url: null, avg_rating: 4.3 },

  // 효고 추가
  { id: '81', name_ko: '다테마사무네', name_ja: '龍力', prefecture_id: 'hyogo', brewery: '혼다 상점', type: '준마이다이긴조', description: '야마다니시키 최고급 특A지구 쌀만 고집하는 효고현의 명주. 쌀의 차이를 맛으로 증명합니다.', image_url: null, avg_rating: 4.4 },
];
